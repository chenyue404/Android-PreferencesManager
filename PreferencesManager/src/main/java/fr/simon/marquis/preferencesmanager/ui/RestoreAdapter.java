...
public class RestoreAdapter extends BaseAdapter {
    ...
    RestoreAdapter(Context ctx, RestoreDialogFragment dialog, List<String> backups, RestoreDialogFragment.OnRestoreFragmentInteractionListener listener, String fullPath) {
    ...
    private String getDisplayLabel(Context ctx, long time) {
